...
export function scoreSales(input: ScoringInput): DomainResult {
  ...
  if (stage?.includes('lost')) factors.push({ id: 'closed-lost', category: 'Sales', weight: 15, impact: -25, title: 'Renewal closed lost', description: 'An associated renewal deal is closed lost.' });
